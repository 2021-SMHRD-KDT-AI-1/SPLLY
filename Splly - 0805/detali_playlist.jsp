        ...
        <!-- Playlist -->
            <section>
                ...
                <div class="album-tracks">
                    <div>
                        <input type="checkbox" class="play-all" onclick="selectAll(this)">전체 선택</input>
                        <script>
                        ...
                        <div class="play-plus" onclick="playPlusOpen()">플레이리스트에 담기</div>
                        <script>
            ...
            <div id="plus-pop">
                <div class="plus-pop-wrap">
                    ...
                    <div class="plus-pop-button">
                        <div onclick="playPlusClose()">닫기</div>
                        <script>
